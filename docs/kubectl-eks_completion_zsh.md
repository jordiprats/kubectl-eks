...
To load completions in your current shell session:
	...
	source <(kubectl-eks completion zsh)

To load completions for every new session, execute once:

#### Linux:

	kubectl-eks completion zsh > "${fpath[1]}/_kubectl-eks"

#### macOS:

	kubectl-eks completion zsh > $(brew --prefix)/share/zsh/site-functions/_kubectl-eks

You will need to start a new shell for this setup to take effect.


```
kubectl-eks completion zsh [flags]
```
