...
List drifted Karpenter nodes and NodeClaims

### Synopsis

List nodes and NodeClaims currently in drifted state across clusters.
...
```
kubectl-eks karpenter drift [flags]
```

### Examples

```
  # List drifted resources for current cluster
  kubectl eks karpenter drift
