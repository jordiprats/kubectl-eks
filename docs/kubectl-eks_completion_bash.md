...
To load completions in your current shell session:
	...
	source <(kubectl-eks completion bash)

To load completions for every new session, execute once:

#### Linux:

	kubectl-eks completion bash > /etc/bash_completion.d/kubectl-eks

#### macOS:

	kubectl-eks completion bash > $(brew --prefix)/etc/bash_completion.d/kubectl-eks
